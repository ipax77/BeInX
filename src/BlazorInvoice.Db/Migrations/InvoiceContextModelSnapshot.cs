...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorInvoice.Db.TempWorkEntry", b =>
                {
                    ...
                    b.Property<byte[]>("WorkEntriesBlob")
                        .IsRequired()
                        .HasColumnType("BLOB");

                    b.HasKey("TempWorkEntryId");

                    b.ToTable("TempWorkEntries");
                });

            modelBuilder.Entity("BlazorInvoice.Db.WorkEntry", b =>
                {
                    ...
                    b.HasIndex("EntryGuid")
                        .IsUnique();

                    b.HasIndex("InvoicePartyId");
            ...
            modelBuilder.Entity("BlazorInvoice.Db.WorkEntry", b =>
                {
                    b.HasOne("BlazorInvoice.Db.InvoiceParty", "InvoiceParty")
                        .WithMany()
                        .HasForeignKey("InvoicePartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
